#ifndef EXAMM_ONENAS_ISLAND_STRATEGY_HXX
#define EXAMM_ONENAS_ISLAND_STRATEGY_HXX
...
class OneNasIsland {
    private:
        ...
        int32_t generate_population_size; /**< The maximum number of genomes in the island. */
        ...
        int32_t status; /**> The status of this island (either OneNasIsland:INITIALIZING, OneNasIsland::FILLED or  OneNasIsland::REPOPULATING */
    ...
    public:
         ...
         */
        OneNasIsland(int32_t id, int32_t _generated_size, int32_t _elite_size);
         ...
         */
        int32_t generated_size();

        int32_t elite_size();

        /**
         * Returns true if the island has OneNasIsland::max_size genomes.
         *
         * \return true if the number of genomes in the island is >= size (although 
         * it should never be > size).
         */
        bool elite_is_full();
        bool generated_is_full();
