...
TimeSeriesEpisode::TimeSeriesEpisode(int32_t id) 
    : episode_id(id), training_score(1), is_loaded(false), access_count(0), importance_score(0.0) {
}

TimeSeriesEpisode::TimeSeriesEpisode(int32_t id, const vector<vector<double>>& _inputs, const vector<vector<double>>& _outputs)
    : episode_id(id), inputs(_inputs), outputs(_outputs), training_score(1), is_loaded(true), access_count(0), importance_score(0.0) {
}
