...
40 at dNet +4.8, t=2.32 over 40 cells -- is therefore recorded as span-
specific noise surviving a max-of-6 selection, not a width effect. This is
...
what width buys is the seed dispersion (worst seed 0.51 -> 0.84), which is
the reliability argument rather than a return argument.
