...
\midrule
ONE-NAS single champion (8 isl., sleeves)$^{c}$ & $+3.1$\se{1.8} & $+1.7$\se{1.3} & $+2.7$\se{1.1} & $+8.5$ \\
...
tolerates the harshest cost assumption, and does so while turning over
least.}
\label{tab:costs}
\end{table}
...
\end{tabular}
\par\smallskip
{\footnotesize Mean $+8.2$; $n{=}6$ runs per cell (2 panels $\times$ 3
seeds).\par}
